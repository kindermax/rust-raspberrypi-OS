...
impl PL011UartInner {
    ...
    /// RPI5 early uart (a.k.a debug uart) already configured by firmware and does not need
    ...
    pub fn init(&mut self) {
        ...
        // TODO: maybe pass clock hz and baud rate from args ?
        self.set_baudrate(48_000_000, 115200);
        self.registers
            .LCR_H
    ...
    // updated on a single write strobe generated by a LCR_H write. So, to internally update
    // the contents of IBRD or FBRD, a LCR_H write must always be performed at the
    // end.
    ...
    pub fn set_baudrate(&self, peripheral_clock_hz: u64, baudrate: u64) {
        ...
        self.registers
            .IBRD
            .write(IBRD::BAUD_DIVINT.val(integer_part as u32));
        self.registers
            .FBRD
            .write(FBRD::BAUD_DIVFRAC.val(fractional_part as u32));
    }
